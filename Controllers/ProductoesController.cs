...
namespace Tiendavirtual.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            var producto = await _context.Productos.FindAsync(id);
            var relacioncompra = await _context.Compras.AnyAsync(c => c.ProductoId == id);
            if (relacioncompra)
            {
                TempData["ErrorMessage"] = "No se puede eliminar el cliente porque tiene compra asociada";
